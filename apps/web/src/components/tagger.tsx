...
export function Tagger({ title, options, setFilterValue, filterValue }: FilterBoxProps) {
                                ...
                                <CommandItem key={option.value} onSelect={() => handleSelect(option.value)}>
                                    <div
                                        className={cn(
                                            ...
                                            selectedValuesSet.has(option.value) ? 'bg-primary text-primary-foreground' : 'opacity-50 [&_svg]:invisible'
                                        )}
                                    >

...
import { CATEGORY_OPTIONS, useUserRacesTableFilters } from './use-user-results-table-filters'
import { DataTableFilterBox } from '@components/ui/table/data-table-filter-box'

export default function SeriesTableAction() {
    const { tagFilter, setTagFilter, isAnyFilterActive, resetFilters, searchQuery, setPage, setSearchQuery } = useUserRacesTableFilters()
    return (

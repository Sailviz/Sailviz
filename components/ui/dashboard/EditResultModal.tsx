...
export default function EditResultModal({ isOpen, result, fleet, raceType, advancedEdit, onSubmit, onClose, onDelete }: { isOpen: boolean, result: ResultsDataType | undefined, fleet: FleetDataType | undefined, raceType: string, advancedEdit: boolean, onSubmit: (resut: ResultsDataType) => void, onDelete: (result: ResultsDataType) => void, onClose: () => void }) {

...
export default function EditResultModal({ isOpen, result, fleet, onClose }: { isOpen: boolean, result: ResultsDataType | undefined, fleet: FleetDataType | undefined, onClose: () => void }) {

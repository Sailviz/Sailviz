import { B as BetterAuthOptions, T as TelemetryContext, t as TelemetryEvent } from './shared/better-auth.CupPPBXF.mjs';
export { A as Adapter, L as AdapterInstance, J as AdapterSchemaCreation, x as AdditionalSessionFieldsInput, y as AdditionalSessionFieldsOutput, v as AdditionalUserFieldsInput, w as AdditionalUserFieldsOutput, b as Auth, c as AuthContext, l as BetterAuthPlugin, O as FilterActions, N as FilteredAPI, G as GenericEndpointContext, H as HookEndpointContext, g as InferAPI, I as InferOptionSchema, m as InferPluginErrorCodes, z as InferPluginTypes, e as InferSession, P as InferSessionAPI, d as InferUser, Z as InternalLogger, Y as LogHandlerParams, Q as LogLevel, X as Logger, M as Models, R as RateLimit, S as SecondaryStorage, F as TransactionAdapter, E as Where, W as WithJsDoc, u as betterAuth, _ as createLogger, D as init, U as levels, $ as logger, V as shouldPublishLog } from './shared/better-auth.CupPPBXF.mjs';
export { A as AtomListener, B as BetterAuthClientPlugin, C as ClientOptions, b as InferActions, i as InferAdditionalFromClient, a as InferClientAPI, c as InferErrorCodes, f as InferPluginsFromClient, g as InferSessionFromClient, h as InferUserFromClient, I as IsSignal, S as SessionQueryParams, e as Store } from './shared/better-auth.DhbdrBWE.mjs';
export { H as HIDE_METADATA } from './shared/better-auth.DEHJp1rk.mjs';
export { g as generateState, p as parseState } from './shared/better-auth.DDN3xvzB.mjs';
...
export { O as OAuth2Tokens, a as OAuth2UserInfo, b as OAuthProvider, P as ProviderOptions } from './shared/better-auth.D4Gj1L5q.mjs';
...
declare function getTelemetryAuthConfig(options: BetterAuthOptions, context?: TelemetryContext): {
    ...
    advanced: {
        ...
        database: {
            useNumberId: boolean;
            generateId: false | packages_core_dist.GenerateIdFn | undefined;
...
export { BetterAuthError, BetterAuthOptions, LiteralUnion, MissingDependencyError, TelemetryEvent, capitalizeFirstLetter, createTelemetry, generateId, getTelemetryAuthConfig };

...
import { I as InferOptionSchema, c as AuthContext, G as GenericEndpointContext, H as HookEndpointContext } from '../../shared/better-auth.CupPPBXF.mjs';
    ...
    user: {
        fields: {
            username: {
                ...
                returned: true;
                transform: {
                    input(value: _better_auth_core_db.DBPrimitive): string | number | boolean | string[] | Date | number[] | null | undefined;
                };
            };
            displayUsername: {
                type: "string";

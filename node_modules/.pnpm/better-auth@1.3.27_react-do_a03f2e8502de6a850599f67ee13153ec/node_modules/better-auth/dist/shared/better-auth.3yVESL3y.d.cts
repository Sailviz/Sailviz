...
import { G as GenericEndpointContext, I as InferOptionSchema, H as HookEndpointContext, c as AuthContext } from './better-auth.WlYTsJnh.cjs';
    ...
    apikey: {
        fields: {
            ...
            metadata: {
                ...
                input: true;
                transform: {
                    input(value: _better_auth_core_db.DBPrimitive): string;
                    output(value: _better_auth_core_db.DBPrimitive): any;
                };
            };
        };
    };

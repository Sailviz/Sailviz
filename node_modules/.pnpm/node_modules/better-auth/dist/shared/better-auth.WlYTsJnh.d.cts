import { b as OAuthProvider, O as OAuth2Tokens, a as OAuth2UserInfo } from './better-auth.Bo4kHJI7.cjs';
...
import { User, Account, Session, Verification, DBFieldAttribute, DBFieldType, DBFieldAttributeConfig, BetterAuthDBSchema, BetterAuthPluginDBSchema } from '@better-auth/core/db';
...
import { DBAdapterDebugLogOption as DBAdapterDebugLogOption$1 } from 'packages/core/dist/db/adapter';
...
type BetterAuthOptions = {
    ...
    database?: PostgresPool | MysqlPool | Database | Dialect | AdapterInstance | Database$1 | DatabaseSync | {
         ...
         * @default false
         */
        debugLogs?: DBAdapterDebugLogOption$1;
        /**
...
export { logger as $, init as D, levels as U, shouldPublishLog as V, createLogger as _, BASE_ERROR_CODES as a, refreshToken as a$, createInternalAdapter as a0, createFieldAttribute as a2, listSessions as aA, revokeSession as aB, revokeSessions as aC, revokeOtherSessions as aD, signOut as aE, requestPasswordReset as aF, forgetPassword as aG, requestPasswordResetCallback as aH, forgetPasswordCallback as aI, resetPassword as aJ, createEmailVerificationToken as aK, sendVerificationEmailFn as aL, sendVerificationEmail as aM, verifyEmail as aN, updateUser as aO, changePassword as aP, setPassword as aQ, deleteUser as aR, deleteUserCallback as aS, changeEmail as aT, error as aU, ok as aV, signUpEmail as aW, listUserAccounts as aX, linkSocialAccount as aY, unlinkAccount as aZ, getAccessToken as a_, createCookieGetter as ac, getCookies as ad, setCookieCache as af, setSessionCookie as ag, deleteSessionCookie as ah, parseCookies as ai, getSessionCookie as ak, getCookieCache as al, parseSetCookieHeader as am, checkEndpointConflicts as an, getEndpoints as ao, router as ap, signInSocial as aq, signInEmail as ar, callbackOAuth as as, getSessionQuerySchema as at, getSession as au, getSessionFromCtx as av, sessionMiddleware as aw, sensitiveSessionMiddleware as ax, requestOnlySessionMiddleware as ay, freshSessionMiddleware as az, accountInfo as b0, originCheckMiddleware as b1, originCheck as b2, checkPassword as f, createAuthMiddleware as n, optionsMiddleware as o, createAuthEndpoint as p, setCookieToHeader as s, betterAuth as u };
export type { Adapter as A, BetterAuthOptions as B, CustomAdapter as C, Where as E, TransactionAdapter as F, GenericEndpointContext as G, HookEndpointContext as H, InferOptionSchema as I, AdapterSchemaCreation as J, KyselyDatabaseType as K, AdapterInstance as L, Models as M, FilteredAPI as N, FilterActions as O, InferSessionAPI as P, LogLevel as Q, RateLimit as R, SecondaryStorage as S, TelemetryContext as T, WithJsDoc as W, Logger as X, LogHandlerParams as Y, InternalLogger as Z, InternalAdapter as a1, InferValueType as a3, InferFieldsOutput as a4, InferFieldsInput as a5, InferFieldsInputClient as a6, FieldAttributeToObject as a7, InferAdditionalFieldsFromPluginOptions as a8, PluginFieldAttribute as a9, InferFieldsFromPlugins as aa, InferFieldsFromOptions as ab, BetterAuthCookies as ae, EligibleCookies as aj, Auth as b, AuthContext as c, InferUser as d, InferSession as e, InferAPI as g, AdapterFactoryOptions as h, AdapterFactoryConfig as i, AdapterFactoryCustomizeAdapterCreator as j, AdapterTestDebugLogs as k, BetterAuthPlugin as l, InferPluginErrorCodes as m, AuthEndpoint as q, AuthMiddleware as r, TelemetryEvent as t, AdditionalUserFieldsInput as v, AdditionalUserFieldsOutput as w, AdditionalSessionFieldsInput as x, AdditionalSessionFieldsOutput as y, InferPluginTypes as z };

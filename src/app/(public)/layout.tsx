        ...
        <div>
            ...
            <footer className='w-full flex flex-col items-center justify-center py-3'>
                ...
                <div className='flex flex-row'>
                    ...
                    <Link isExternal className='flex items-center gap-1 text-current' href='https://nextui.org/' title='nextui.org homepage'>
                        <p className='text-primary'>NextUI</p>
                    </Link>
                    <span className='text-default-600'>&ensp;and&ensp;</span>
                    <Link isExternal className='flex items-center gap-1 text-current' href='https://nextjs.org/' title='nextjs.org homepage'>

...
const CountdownTimer = ({ startTime, endTime, timerActive, onFourMinutes, onOneMinute, onGo, onEnd, reset }: { startTime: number, endTime: number, timerActive: boolean, onFourMinutes: any, onOneMinute: any, onGo: any, onEnd: any, reset: boolean }) => {

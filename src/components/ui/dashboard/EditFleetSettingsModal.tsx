...
export default function EditFleetSettingsModal({
    isOpen,
    fleetSettings,
    onSubmit,
    onClose
        ...
        <>
            <Modal isOpen={isOpen} onClose={onClose} scrollBehavior={'outside'} size='5xl' backdrop='blur'>
                <ModalContent>
                    {onClose => (
                        <>
                            <ModalHeader className='flex flex-col gap-1'>Edit Fleet</ModalHeader>
                            <ModalBody>
                            ...
                            <ModalFooter>
                                ...
                                <Button
                                    color='primary'
                                    onPress={() => onSubmit({ ...fleetSettings!, name: name, startDelay: startDelay, boats: selectedBoats.flatMap(boats => boats.value) })}
                                >
                                    Save
                                </Button>
                            </ModalFooter>

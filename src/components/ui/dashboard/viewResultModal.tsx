        ...
        <>
            <Modal isOpen={isOpen} onClose={onClose} scrollBehavior={'outside'} size='5xl' backdrop='blur'>
                <ModalContent>
                    {onClose => (
                        <>
                            <ModalHeader className='flex flex-col gap-1'>View Result</ModalHeader>
                            <ModalBody>
                                <div className='flex w-full flex-col'>
                                                    ...
                                                    styles={{
                                                        ...
                                                        option: (provided, state) =>
                                                            ({
                                                                ...
                                                                backgroundColor:
                                                                    theme == 'dark' ? (state.isSelected ? '#27272a' : '#18181b') : state.isSelected ? '#f4f4f5' : 'white',
                                                                '&:hover': {
                                    ...
                                    <div className='flex flex-row mt-2'>
                                        <div className='flex flex-col px-6 w-1/4'>
                                            <Input type='number' label='Position' placeholder=' ' labelPlacement='outside' />
                                        </div>
                                        <div className='flex flex-col px-6 w-1/4'>
                                            <p>Finish Code</p>
                                            <div className='w-full p-2 mx-0 my-2'>
